...
class SupplierSearch extends Supplier
{
    ...
    public function search($params)
    {
        ...
        $symbol = '=';
        !empty($this->id['symbol']) and $symbol=$this->id['symbol'];
        !empty($this->id['value']) and $id=$this->id['value'];
        if(isset($id)){
            $query->andFilterCompare('id', "{$symbol}{$id}");
        }
...
//        ]);
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterCompare('t_status', $this->t_status);
